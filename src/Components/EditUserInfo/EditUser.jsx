                ...
                <div className="infoLowerAdult">
                    ...
                    <div className="passenger-form-adult">
                        <div className="grid-container-adult">
                            <FormField label="First Name" name="firstName" type="text" placeholder="Enter your first name" className="input-fieldA" value={formData.firstName} onChange={handleChange} required />
                            <FormField label="Last Name" name="lastName" type="text" placeholder="Enter your last name" className="input-fieldA" value={formData.lastName} onChange={handleChange} required />
